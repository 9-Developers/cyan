...
// configuration step. It creates a namespace called `cyan`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cyan::cmake::project_name, cyan::cmake::project_version) };
